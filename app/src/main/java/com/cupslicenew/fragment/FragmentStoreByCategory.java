 ...
 */
public class FragmentStoreByCategory extends BaseFragment {

    View main_view;
    BaseActivity activity;
    HelperGlobal.FragmentInterface fragmentInterface;
    public static final String TAG_FRAGMENT_STORE_BY_CATEGORY = "tag:fragment-store-by-category";


    @Nullable
    @Override
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        main_view = inflater.inflate(R.layout.fragment_store_by_category, container, false);
        return main_view;
    }
    ...
    public String getFragmentTAG() {
        return TAG_FRAGMENT_STORE_BY_CATEGORY;
    }
