 ...
 */
public class FragmentStoreTabPopular extends BaseFragment {

    View main_view;
    BaseActivity activity;
    HelperGlobal.FragmentInterface fragmentInterface;
    public static final String TAG_FRAGMENT_STORE_TAB_POPULAR = "tag:fragment-store-tab-popular";
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        main_view = inflater.inflate(R.layout.fragment_store_tab_popular, container, false);
        return main_view;
    }
    ...
    public String getFragmentTAG() {
        return TAG_FRAGMENT_STORE_TAB_POPULAR;
    }
