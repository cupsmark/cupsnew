 ...
 */
public class FragmentStoreTabNew extends BaseFragment {

    View main_view;
    BaseActivity activity;
    HelperGlobal.FragmentInterface fragmentInterface;
    public static final String TAG_FRAGMENT_STORE_TAB_NEW = "tag:fragment-store-tab-new";
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        main_view = inflater.inflate(R.layout.fragment_store_tab_new, container, false);
        return main_view;
    }
    ...
    public String getFragmentTAG() {
        return TAG_FRAGMENT_STORE_TAB_NEW;
    }
}
